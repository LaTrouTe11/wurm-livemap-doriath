...
WurmMapGen.map = {
	...
	create: function() {
		...
		for (var i = 0; i < WurmMapGen.villages.length; i++) {
			...
			// INTEGRATION EN DUR : Style Or, Émeraude et Options Natives Leaflet anti-tremblement
			marker.bindPopup([
				...
				keepInView: true,
				autoPan: true,
				offset: L.point(0, -20), // Décale la bulle vers le haut par rapport à l'icône de la maison
				autoPanPaddingTopLeft: L.point(50, 260), // Repousse la vue vers le bas pour dégager le menu de gauche
